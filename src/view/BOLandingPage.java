 ...
 * @author Asus
 */
public class BOLandingPage extends javax.swing.JFrame {

    /**
     * Creates new form BOLandingPage
     */
    public BOLandingPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        HeaderTitle.setText("Back Office Page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BOLandingPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BOLandingPage().setVisible(true);
            }
        });
    }
