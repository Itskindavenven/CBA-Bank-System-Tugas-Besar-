...
public class TableCS extends AbstractTableModel{
    private List<Customer_Service> list;
    
    public TableCS(List<Customer_Service> list){
        this.list = list;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex){
        switch(columnIndex){
            case 0:
                return list.get(rowIndex).getCs_id();
            case 1:
